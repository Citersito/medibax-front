<template>
	<div class="expediente-admin-container">
			...
			<ul>
				<li v-for="expediente in expedientes" :key="expediente.id_expediente">
					...
					<div v-else>
						...
						<button @click="editExpediente(expediente.id_expediente)">
							Editar
						</button>
						<button @click="deleteExpediente(expediente.id_expediente)">
							Eliminar
						</button>
					</div>
				</li>
		...
		<div>
			...
			<ul>
				<li
					v-for="antecedente in antecedentesFamiliares"
					:key="antecedente.id_antecedente_familiar"
				>
					<div
						v-if="
							antecedenteFamiliarEditId === antecedente.id_antecedente_familiar
						"
					>
						<form
							@submit.prevent="
								saveAntecedenteFamiliar(antecedente.id_antecedente_familiar)
							"
						>
							<input
								v-model="antecedente.descripcion"
								type="text"
								placeholder="Descripción del antecedente familiar"
								required
							/>
							<button type="submit">Guardar</button>
							<button type="button" @click="cancelEdit">Cancelar</button>
					...
					<div v-else>
						...
						<button
							@click="
								editAntecedenteFamiliar(antecedente.id_antecedente_familiar)
							"
						>
							Editar
						</button>
						<button
							@click="
								deleteAntecedenteFamiliar(antecedente.id_antecedente_familiar)
							"
						>
							Eliminar
						</button>
			...
			<button @click="addAntecedenteFamiliar">
		...
		<div>
			...
			<ul>
				<li
					v-for="antecedente in antecedentesPersonales"
					:key="antecedente.id_antecedente_personal"
				>
					<div
						v-if="
							antecedentePersonalEditId === antecedente.id_antecedente_personal
						"
					>
						<form
							@submit.prevent="
								saveAntecedentePersonal(antecedente.id_antecedente_personal)
							"
						>
							<input
								v-model="antecedente.descripcion"
								type="text"
								placeholder="Descripción del antecedente personal"
								required
							/>
							<button type="submit">Guardar</button>
							<button type="button" @click="cancelEdit">Cancelar</button>
					...
					<div v-else>
						...
						<button
							@click="
								editAntecedentePersonal(antecedente.id_antecedente_personal)
							"
						>
							Editar
						</button>
						<button
							@click="
								deleteAntecedentePersonal(antecedente.id_antecedente_personal)
							"
						>
							Eliminar
						</button>
			...
			<button @click="addAntecedentePersonal">
			...
			<ul>
				...
				>
					...
					<div v-else>
						...
						<button @click="editHistoriaClinica(historia.id_historia_clinica)">
							Editar
						</button>
						<button
							@click="deleteHistoriaClinica(historia.id_historia_clinica)"
						>
							Eliminar
						</button>
					</div>
		...
		<div>
			...
			<ul>
				<li
					v-for="modificacion in modificacionesExpediente"
					:key="modificacion.id_modificacion"
				>
					<div v-if="modificacionEditId === modificacion.id_modificacion">
						<form
							@submit.prevent="saveModificacion(modificacion.id_modificacion)"
						>
							<input
								v-model="modificacion.descripcion"
								type="text"
					...
					<div v-else>
						...
						<button @click="editModificacion(modificacion.id_modificacion)">
							Editar
						</button>
						<button @click="deleteModificacion(modificacion.id_modificacion)">
							Eliminar
						</button>
					</div>
				</li>
